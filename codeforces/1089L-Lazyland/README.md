...
**Problem:** [1089L-Lazyland](https://codeforces.com/contest/1089/problem/L)
...
The first line of the input contains two integers n and k (1 ≤ k ≤ n ≤ 10⁵) — the number of idlers and the number of jobs.

The second line of the input contains n integers a_1, a_2, …, a_n (1 ≤ a_i ≤ k) — the jobs chosen by each idler.

The third line of the input contains n integers b_1, b_2, …, b_n (1 ≤ b_i ≤ 10⁹) — the time the King needs to spend to persuade the i-th idler.
